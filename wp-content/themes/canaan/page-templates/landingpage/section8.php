...
<form action="" name='form' class="lp_form-js" method="POST">
    <div id="section-8" class="vvv py-16 mx-auto w-bbc bg-mainOrange flex justify-center">
        ...
        <div class="flex-row lp_sec9_right mx-10">

            <h1 class="lp-section9-title my-5">צרו עימנו קשר</h1>
        ...
        <div class="lp_sec9_left flex-row mx-10">
            ...
            <div class="flex justify-evenly my-2">
                ...
                <div class="text-mainWhite">
                    <input id="input2" type="radio" class="lp_sec9_checkbox mx-2" name="look_for_job_education" value="eployer">
                    <label for="input2" class="lp_sec8_text">מעסיק</label>
                </div>

                <div class="text-mainWhite">
                    <input id="input3" type="radio" class="lp_sec9_checkbox mx-2" name="look_for_job_education" value="help">
                    <label for="input3" class="lp_sec8_text">מרכז ייעוץ תעסוקתי</label>
                </div>
            </div>

            <div class="flex-col">
                <input id="input4" class="lp_sec9_inputs  mx-2 my-2 " type="text" placeholder="שם מלא" name="full-name">
                <input type="tel" placeholder="טלפון" class="lp_sec9_inputs mx-2 my-2" name="form-tel">
            </div>

            <div class="flex-col">
                <input type="email" placeholder="מייל" class="lp_sec9_inputs mx-2 my-2" name="form-mail">
                <button class="lp_sec9_inputs mx-2 my-2">שלח</button>
            </div>
