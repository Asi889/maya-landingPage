...
<div class="section2_body section2_body_width ">
    ...
    <div class="lp-section2-button settings-wrapper relative">
        <img class="question-mark white-question" src="<?php echo get_template_directory_uri() . '/static/images/whiteQuestionMark.svg'; ?>" alt="<?php echo get_bloginfo('name'); ?>">
        <img class="question-mark green-question" src="<?php echo get_template_directory_uri() . '/static/images/greenQuestionMark.svg'; ?>" alt="<?php echo get_bloginfo('name'); ?>">
        <div class="tooltip-wrapper text-black text-sm">
            <?php
            $reskilling_text = carbon_get_the_post_meta('page-homereskill-tooltip'); 
            echo '<p class="" >' . $reskilling_text . '</p>';
            ?>
        </div>
    ...
    <div class="lp-section2-button relative person-wrapper">
        ...
        <div class="tooltip-wrapper text-black text-sm">
            ...
            $upskilling_text = carbon_get_the_post_meta('page-homeupskill-tooltip');
            echo '<p class="" >' . $upskilling_text . '</p>';
            ?>
        </div>
